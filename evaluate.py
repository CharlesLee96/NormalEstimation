...
parser.add_argument('--normal_results_path', type=str, default='./log_ablation_noLw/test_LAB12345+GAB_order4/results/', help='Log dir [default: log]')
parser.add_argument('--data_path', type=str, default='/home/lys/volume5/Data/PCPNet/', help='Relative path to data directory')
